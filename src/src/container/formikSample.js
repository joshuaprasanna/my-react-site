...
import FormikBasicDetails, {ForimBasicDetails} from "../components/ForimBasicDetails";
import { formikValidation, forrmikInitialValues } from "../service/formikService";
...
<FormikBasicDetails formIk={formIk} message={"testing"} ></FormikBasicDetails>
</Tab>
...
(formikDetails)=> {
 ...
 return   <FieldArrayNew formikDetails={formikDetails}  ></FieldArrayNew>
