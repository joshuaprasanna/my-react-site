 ...
 export function Nivas1()
{
    ...
    function GetStudentDetails() {
      axios.get("https://dummyjson.com/products").then((response) => {
       ...
       setHolidaysList(response.data.products.filter
        ((row)=>{return row.item_code<=10}));
...
<Row style={{ backgroundColor: "#29314a", height: "120px" }}>
      ...
      <Row md={12} style={{ backgroundColor: "#3b8edb", height: "50px", width: "1840px", 
      marginLeft: "20px" }}>
      ...
      <SimpleImageSlider
            ...
            showBullets={true}
            showNavs={true}
            style={{marginTop:"-350px",marginLeft:"930px"}}
          />
    ...
    <Row md={12} style={{ backgroundColor: "#537699", height: "50px", width: "1840px", marginLeft: "20px",marginTop:"10px" }}>
...
<br></br>
<Row md={2} style={{backgroundColor:"#29314a"}}> <h5 style={{color:"white",content:"-moz-initial"}}>Desighned & Developed By <b style={{color:"#e39b59"}}>APCFSS</b></h5></Row>
